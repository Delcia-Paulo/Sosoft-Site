      ...
      <div>
        <div className="relative w-full h-screen overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col  items-center justify-center h-full text-center text-white  px-4">
            <h1 className="  text-4xl font-extrabold drop-shadow-lg text-container cursor-default ">
        ...
        <h1
          id="Serviços"
          className="text-black font-bold items-center justify-center flex mt-10 text-4xl "
        >
          Nossos Serviços
        </h1>
        ...
        <h1 className="font-bold items-center justify-center mb-12 flex text-4xl transition-colors duraction-700 cursor-default text-[#F19209] hover:text-[#04639b]">
          Contacte-nos!
        </h1>
        <div className="items-center justify-center flex  mb-10">
          <button className="bg-[#F19209] p-4 shadow-lg rounded-xl transition-colors duraction-700 text-lg hover:bg-yellow-400 hover:p-5 text-white ">
            Peça um orçamento
            <img
              src={arrow}
              alt="Seta"
